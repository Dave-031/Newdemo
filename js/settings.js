...
const catThemes = {
    cat: "url('https://cdn.jsdelivr.net/gh/Dave-031/Newdemo@latest/cat_anim/Idle.png')",
    meevin: "url('https://cdn.jsdelivr.net/gh/Dave-031/Newdemo@latest/cat_anim/meevin.png')"
};
