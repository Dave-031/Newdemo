...
(function setupTaskbarCat() {
    ...
    // Fetches a game-list JSON, renders cards into `listElId`, and wires
    // `searchElId` to actually filter the rendered cards by name as you type.
    function setupGameGrid(jsonUrl, listElId, searchElId) {
        ...
        function renderGrid(filterText) {
            ...
            filtered.forEach(game => {
                ...
                gameDiv.onclick = () => window.location.href = game.link;
        ...
        fetch(jsonUrl)
            ...
            .then(games => {
                gameData = Array.isArray(games) ? games : [];
...
(function () {
    const GAS_API_BASE = "https://script.google.com/macros/s/AKfycbxLjkrn_3_nizxaQVl8iMal9rpX8aaSyXHnN7nuKbiEUWy_RZxGDFLepl6WsnoPnu6b9A/exec";
